@extends('admin.index')
@section('tittle','Crear empresa')
@section('content')
<div class="container">
    <div class="row py-lg-2">
        <div class="col-md-6"><h2>Ingresar empresa</h2></div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group has-feedback row">
                                    ...
                                    <div class="col-12">
                                        <input name="nombreEmpresa" class="form-control" type="text" max="70" value="{{ old('nombreEmpresa') }}" ></input>
                                    </div>
                                </div>
                            </div>
                        </div>
